...
public class Consumer2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueDeclare(RabbitConstant.QUEUE_WEIBO, false, false, false, null);
        channel.queueBind(RabbitConstant.QUEUE_WEIBO, RabbitConstant.EXCHANGE_PULISH, "");
        channel.basicQos(1);
        //从mq服务器拉取数据
        ...
        //从mq服务器拉取数据
        channel.basicConsume(RabbitConstant.QUEUE_WEIBO, false, new DefaultConsumer(channel) {
            @Override
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws
                    IOException {
                System.out.println("微博天气收到的气象信息" + new String(body));
