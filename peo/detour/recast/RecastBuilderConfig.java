...
public class RecastBuilderConfig {
    ...
    public final org.recast4j.recast.RecastConfig cfg;
    ...
    public RecastBuilderConfig(org.recast4j.recast.RecastConfig cfg, float[] bmin, float[] bmax) {
        this(cfg, bmin, bmax, 0, 0, false);
    }

    public RecastBuilderConfig(org.recast4j.recast.RecastConfig cfg, float[] bmin, float[] bmax, int tx, int ty, boolean tiled) {
