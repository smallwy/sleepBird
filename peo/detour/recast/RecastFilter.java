...
public class RecastFilter {
    ...
    public static void filterLowHangingWalkableObstacles(org.recast4j.recast.Context ctx, int walkableClimb, org.recast4j.recast.Heightfield solid) {
        ...
        for (int y = 0; y < h; ++y) {
            for (int x = 0; x < w; ++x) {
                org.recast4j.recast.Span ps = null;
                boolean previousWalkable = false;
                int previousArea = RecastConstants.RC_NULL_AREA;

                for (org.recast4j.recast.Span s = solid.spans[x + y * w]; s != null; ps = s, s = s.next) {
    ...
    ///
    /// @see rcHeightfield, rcConfig
    public static void filterLedgeSpans(org.recast4j.recast.Context ctx, int walkableHeight, int walkableClimb, org.recast4j.recast.Heightfield solid) {
        ...
        for (int y = 0; y < h; ++y) {
            for (int x = 0; x < w; ++x) {
                for (org.recast4j.recast.Span s = solid.spans[x + y * w]; s != null; s = s.next) {
                    ...
                    for (int dir = 0; dir < 4; ++dir) {
                        int dx = x + org.recast4j.recast.RecastCommon.GetDirOffsetX(dir);
                        ...
                        org.recast4j.recast.Span ns = solid.spans[dx + dy * w];
