...
public class RecastArea {
    ...
    public static void erodeWalkableArea(org.recast4j.recast.Context ctx, int radius, CompactHeightfield chf) {
        int w = chf.width;
        int h = chf.height;
    ...
    public boolean medianFilterWalkableArea(org.recast4j.recast.Context ctx, CompactHeightfield chf) {
    ...
    public void markBoxArea(org.recast4j.recast.Context ctx, float[] bmin, float[] bmax, AreaModification areaMod, CompactHeightfield chf) {
    ...
    ///
    /// @see rcCompactHeightfield, rcMedianFilterWalkableArea
    public static void markConvexPolyArea(org.recast4j.recast.Context ctx, float[] verts, float hmin, float hmax, AreaModification areaMod,
