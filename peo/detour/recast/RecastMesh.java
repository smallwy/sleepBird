...
public class RecastMesh {
    ...
    private static boolean canRemoveVertex(org.recast4j.recast.Context ctx, org.recast4j.recast.PolyMesh mesh, int rem) {
        int nvp = mesh.nvp;
    ...
    private static void removeVertex(org.recast4j.recast.Context ctx, org.recast4j.recast.PolyMesh mesh, int rem, int maxTris) {
        int nvp = mesh.nvp;
    ...
    public static org.recast4j.recast.PolyMesh buildPolyMesh(org.recast4j.recast.Context ctx, ContourSet cset, int nvp) {
        ctx.startTimer("BUILD_POLYMESH");
        org.recast4j.recast.PolyMesh mesh = new org.recast4j.recast.PolyMesh();
    ...
    public static org.recast4j.recast.PolyMesh mergePolyMeshes(org.recast4j.recast.Context ctx, org.recast4j.recast.PolyMesh[] meshes, int nmeshes) {
        ...
        for (int i = 0; i < nmeshes; ++i) {
            org.recast4j.recast.PolyMesh pmesh = meshes[i];
    ...
    public static org.recast4j.recast.PolyMesh copyPolyMesh(Context ctx, org.recast4j.recast.PolyMesh src) {
        org.recast4j.recast.PolyMesh dst = new PolyMesh();
